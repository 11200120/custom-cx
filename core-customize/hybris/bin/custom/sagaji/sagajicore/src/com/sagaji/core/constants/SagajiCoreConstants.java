 ...
 */
package com.sagaji.core.constants;

/**
 * Global class for all SagajiCore constants. You can add global constants for your extension into this class.
 */
public final class SagajiCoreConstants extends GeneratedSagajiCoreConstants
{
	public static final String EXTENSIONNAME = "sagajicore";


	private SagajiCoreConstants()
	{
		//empty
	}

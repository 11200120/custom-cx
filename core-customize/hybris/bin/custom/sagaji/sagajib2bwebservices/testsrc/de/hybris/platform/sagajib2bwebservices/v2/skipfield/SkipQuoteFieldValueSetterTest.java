...
public class SkipQuoteFieldValueSetterTest extends BaseSkipFieldTest
{
	@InjectMocks
	...
	public void testSetValue()
	{
		...
		when(dataMapper.map(anyObject(), eq(QuoteWsDTO.class), anyString())).thenReturn(quoteWsDTO);
		skipQuoteFieldValueSetter.setValue(FIELD_ENTRIES);

...
import com.sagaji.test.constants.SagajiTestConstants;
import com.sagaji.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SagajiTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/sagajitest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/sagajitest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/sagajitest/import/cstickets.impex");
			...
			importImpexFile(context, "/sagajitest/import/csquotes.impex");
		}
	}
}

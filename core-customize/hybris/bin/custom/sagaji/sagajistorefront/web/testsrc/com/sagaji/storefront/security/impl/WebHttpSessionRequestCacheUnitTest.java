...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sagajistorefront/electronics/en",
						"https://electronics.local:9002/sagajistorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sagajistorefront/electronics/en",
						"https://electronics.local:9002/sagajistorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sagajistorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/sagajistorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sagajistorefront/electronics/en",
						"https://electronics.local:9002/sagajistorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sagajistorefront",
						"https://electronics.local:9002/sagajistorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sagajistorefront",
						"https://electronics.local:9002/sagajistorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/sagajistorefront/electronics/en",
						"https://electronics.local:9002/sagajistorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}

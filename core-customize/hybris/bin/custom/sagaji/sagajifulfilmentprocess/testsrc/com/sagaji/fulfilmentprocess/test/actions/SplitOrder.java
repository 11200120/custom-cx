 ...
 */
package com.sagaji.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(SagajiFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SagajiFulfilmentProcessConstants.PARENT_PROCESS);
